...
if len(sys.argv) != 4:
    print("用法:  python a6.4.json.image.k562.object.py k562_rna_ribo_features.jsonl k562_rna_images/ k562_rna_encoded/train_k562.jsonl")
    sys.exit(1)
...
with open(input_jsonl, "r") as f:
    for idx, line in enumerate(f):
        ...
        try:
            ...
            # 保存矩阵
            new_image_path = os.path.join(output_image_dir, f"{transcript_id}.png")
            json_item = {
